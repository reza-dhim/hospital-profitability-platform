...
/**
 * shadcn/ui-style primitive. Card-based layout per
 * docs/36_DESIGN_PRINCIPLES.md §1: "all grouped content lives in a Card
 * primitive with consistent radius/shadow tokens — no ungrouped floating
 * content on data pages."
 */
